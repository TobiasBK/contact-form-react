...
//This component uses Typescript, tailwindCSS, axios, google-recaptcha (requires self-hosted domain to work)
//Uses https://www.formspark.io/    =>Get formId here...

//formState = type of data sotred in State.
type FormState = {
    email: string;
    name: string;
    message: string;
